                            ...
                            <form action="../../services/CadastrandoEquipamento.php" method="POST">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="patrimonio" placeholder="">
                                    </div>
                                    <div class="form-group col-md-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="date" class="form-control date" id="validade" name="validade" placeholder="">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label>FABRICAÇÃ0</label>
                                        <input type="date" class="form-control" id="fabricacao" name="fabricacao" placeholder="">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <label>OBSERVAÇÃO </label>
                                        <textarea class="form-control " name="obs" id="" cols="30" rows="1" placeholder=""></textarea>
                                    </div>
                                    <div class="form-group col-md-4" style="text-align: center;">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label>
                                                <input value="ordi" type="radio" name="tipo" required style=" margin-left: 10px;">
                                                ORDINÁRIO
                                            </label>
                                        </div>
                                    </div>
