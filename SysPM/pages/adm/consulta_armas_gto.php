              ...
              <tbody id="myTable">
                ...
                <tr>
                  ...
                  <td style="display: flex;justify-content: space-around;flex-wrap: nowrap;">
                    <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#modalEdit<?php echo $linhas['id'] ?>" data-bs-whatever="<?= $linhas['modelo'] ?>" data-bs-whatever2="<?= $linhas['marca'] ?>" data-bs-whatever9="<?= $linhas['id'] ?>" data-bs-whatever7="<?= $linhas['situacao'] ?>" data-bs-whatever3="<?= $linhas['n_serie'] ?>" data-bs-whatever4="<?= $linhas['patrimonio'] ?>" data-bs-whatever5="<?= $linhas['localizacao'] ?>" data-bs-whatever6="<?= $linhas['cautela'] ?>" data-bs-whatever8="<?= $linhas['obs'] ?>">Editar</button>
          ...
          <div class="modal-body">
            ...
            <form action="../../services/UpandoFoto.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="id" id="id_arma">
            ...
            <form action="../../services/EditandoArma.php" method="POST" onsubmit="return  verificar()">
              ...
              <div>
                ...
                <textarea id="obs" name="obss" cols="55" rows="4"> </textarea>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body" id="historico">
              <div style="width: 100%;">
                <img src="../../img/fotos_armas/<?php echo $linhas['foto'] ?>" alt="Sem Foto!" style="width: 170px;height: 150px;left: 50%;transform: translate(-50%);position: relative;">
              </div>
              <div class="container">
...
<script>
  ...
  exampleModal.addEventListener('show.bs.modal', function(event) {
    ...
    var modalBodyInput = exampleModal.querySelector('#id_arma')
    modalBodyInput.value = id
